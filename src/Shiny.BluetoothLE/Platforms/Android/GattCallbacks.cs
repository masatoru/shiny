...
class GattCallbacks : BluetoothGattCallback
{
    ...
    public Subject<(BluetoothGatt? Gatt, GattStatus Status, ProfileState ProfileState)> ConnectionStateChanged { get; } = new Subject<(BluetoothGatt? Gatt, GattStatus Status, ProfileState ProfileState)>();
    public override void OnConnectionStateChange(BluetoothGatt? gatt, GattStatus status, ProfileState newState)
        => this.ConnectionStateChanged.OnNext((gatt, status, newState));
}