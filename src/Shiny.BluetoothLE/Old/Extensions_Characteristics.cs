...
//                throw new InvalidOperationException($"No service found - {serviceUuid}");
//        });
...
//                throw new InvalidOperationException($"No characteristic found - {serviceUuid}/{characteristicUuid}");
//        });
